...
public class TestArrayImplementations {
	...
	public void test_two_array_implementation_insert() {
		...
		try {
			...
			assertEquals("d1", d.def[0]);
			assertEquals("d2", d.def[1]);
			assertEquals("d3", d.def[2]);
			assertEquals("d4", d.def[3]);
			assertEquals("d5", d.def[4]);
	...
	public void test_two_array_implementation_remove() {
		...
		try {
			...
			assertEquals("d1", d.def[0]);
			assertEquals("d3", d.def[1]);
			assertEquals("d4", d.def[2]);
			assertEquals("d5", d.def[3]);
