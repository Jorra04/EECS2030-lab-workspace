...
public class LZWDictionary {
	...
	public int indexOf(String s) {
		if(this.HashTable.containsKey(s) == true) {
	...
	public void reset() {
		...
		for (int i = 0; i < this.myList.size(); i++) {
			this.HashTable.put(this.myList.get(i), i);
		}
	...
	public String get(int index) {
		if(index> this.HashTable.size() || index<0) {
			throw new IllegalArgumentException();
		}
		for()
	...
	public int add(String entry) {
		...
		if(this.HashTable.containsKey(entry) == true) {
			return this.HashTable.get(entry);
		}
		else {
			this.myList.add(entry);
			this.HashTable.put(entry, this.myList.indexOf(entry));
			return this.HashTable.get(entry);
		}
	...
	public boolean contains(String s) {
		...
		return this.HashTable.containsValue(s);
